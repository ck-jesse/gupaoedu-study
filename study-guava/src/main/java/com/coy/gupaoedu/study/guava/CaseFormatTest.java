...
public class CaseFormatTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(CaseFormat.LOWER_UNDERSCORE.to(CaseFormat.LOWER_CAMEL, "test_data"));// 下划线 转 驼峰(首字母小写)
        System.out.println(CaseFormat.LOWER_UNDERSCORE.to(CaseFormat.LOWER_CAMEL, "TEST_DATA"));// 下划线 转 驼峰(首字母小写)
        System.out.println(CaseFormat.UPPER_UNDERSCORE.to(CaseFormat.UPPER_CAMEL, "test_data"));// 下划线 转 驼峰(首字母大写)
