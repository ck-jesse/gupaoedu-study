...
//     * @return
//     */
//    public static BitMatrix createQRCode(String content, int heightPix) {
...
//     * @return
//     */
//    public static BitMatrix createQRCode(String content, int heightPix, int codeColor) {
...
//     * @return
//     */
//    public static BitMatrix createQRCode(String content, int heightPix, BitMatrix logo) {
//        return createQRCode(content, heightPix, logo, Color.BLACK.getRGB());
//    }
//
//    /**
//     * 生成我二维码
...
//     * @return
//     */
//    public static BitMatrix createQRCode(String content, int heightPix, BitMatrix logo, int codeColor) {
...
//     * @return
//     */
//    public static BitMatrix createQRCode(String content, int heightPix, BitMatrix logo, float ratio) {
//        //配置参数
...
//     * @return
//     */
//    public static BitMatrix createQRCode(String content, int heightPix, BitMatrix logo, float ratio, int codeColor) {
//        //配置参数
//        Map<EncodeHintType, Object> hints = new HashMap<>();
//        hints.put(EncodeHintType.CHARACTER_SET, "utf-8");
//        //容错级别
...
//        return createQRCode(content, heightPix, logo, ratio, hints, Color.BLACK.getRGB());
//    }
//
//    /**
//     * 生成二维码
...
//                    } else {
//                        pixels[y * heightPix + x] = Color.WHITE.getRGB();
//                    }
//                }
//            }
//
//            // 生成二维码图片的格式
//            BitMatrix bitmap = BitMatrix.createBitmap(heightPix, heightPix, BitMatrix.Config.ARGB_8888);
...
//     * @return
//     */
//    private static BitMatrix addLogo(BitMatrix src, BitMatrix logo, float ratio) {
//        if (src == null) {
//            return null;
//        }
//
...
//        BitMatrix bitmap = BitMatrix.createBitmap(srcWidth, srcHeight, BitMatrix.Config.ARGB_8888);
//        try {
...
//     * @return
//     */
//    private static BitMatrix compressBitmap(String path, int reqWidth, int reqHeight) {
//
...
//     * @return
//     */
//    private static RGBLuminanceSource getRGBLuminanceSource(@NonNull BitMatrix bitmap) {
...
//     * @return
//     */
//    public static BitMatrix createBarCode(String content, int desiredWidth, int desiredHeight) {
...
//     * @return
//     */
//    public static BitMatrix createBarCode(String content, BarcodeFormat format, int desiredWidth, int desiredHeight) {
//        return createBarCode(content, format, desiredWidth, desiredHeight, null);
//    }
//
//    public static BitMatrix createBarCode(String content, int desiredWidth, int desiredHeight, boolean isShowText) {
//        return createBarCode(content, BarcodeFormat.CODE_128, desiredWidth, desiredHeight, null, isShowText, 40, Color.BLACK.getRGB());
//    }
//
//    /**
//     * 生成条形码
...
//     * @return
//     */
//    public static BitMatrix createBarCode(String content, int desiredWidth, int desiredHeight, boolean isShowText, int codeColor) {
...
//     * @return
//     */
//    public static BitMatrix createBarCode(String content, BarcodeFormat format, int desiredWidth, int desiredHeight, Map<EncodeHintType, ?> hints) {
//        return createBarCode(content, format, desiredWidth, desiredHeight, hints, false, 40, Color.BLACK.getRGB());
//    }
//
//    /**
//     * 生成条形码
...
//    public static BitMatrix createBarCode(String content, BarcodeFormat format, int desiredWidth, int desiredHeight, Map<EncodeHintType, ?> hints,
//                                          boolean isShowText) {
//        return createBarCode(content, format, desiredWidth, desiredHeight, hints, isShowText, 40, Color.BLACK.getRGB());
//    }
//
//    /**
//     * 生成条形码
...
//     * @return
//     */
//    public static BitMatrix createBarCode(String content, BarcodeFormat format, int desiredWidth, int desiredHeight, boolean isShowText,
//                                          int codeColor) {
...
//     */
//    public static BitMatrix createBarCode(String content, BarcodeFormat format, int desiredWidth, int desiredHeight, Map<EncodeHintType, ?> hints,
//                                          boolean isShowText, int codeColor) {
...
//     */
//    public static BitMatrix createBarCode(String content, BarcodeFormat format, int desiredWidth, int desiredHeight, Map<EncodeHintType, ?> hints,
//                                          boolean isShowText, int textSize, int codeColor) {
...
//            }
//
//            BitMatrix bitmap = BitMatrix.createBitmap(width, height,
//                    BitMatrix.Config.ARGB_8888);
...
//     * @return
//     */
//    private static BitMatrix addCode(BitMatrix src, String code, int textSize, int textColor, int offset) {
//        if (src == null) {
//            return null;
//        }
//
...
//        }
//
//        BitMatrix bitmap = BitMatrix.createBitmap(srcWidth, srcHeight + textSize + offset * 2, BitMatrix.Config.ARGB_8888);
//        try {
//            Canvas canvas = new Canvas(bitmap);
//            canvas.drawBitmap(src, 0, 0, null);
