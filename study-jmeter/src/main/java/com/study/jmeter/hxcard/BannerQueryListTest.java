...
import com.hx.card.service.proto.BannerConfigProto;
 ...
 */
public class BannerQueryListTest extends AbstractJavaSamplerClient {
    ...
    public SampleResult runTest(JavaSamplerContext javaSamplerContext) {
        ...
        // 开始计时
        result.sampleStart();
        String url = UrlUtil.buildURL(ip, port, "/hx-card-service/bannerConfig/queryBannerConfigList");

        BannerConfigProto.BannerConfigQueryListRequest.Builder builder = BannerConfigProto.BannerConfigQueryListRequest.newBuilder();
        ...
        BannerConfigProto.BannerConfigQueryListResponse response = RestTemplateInstance.protoRestTemplate.postForObject(url, builder.build(),
                BannerConfigProto.BannerConfigQueryListResponse.class);
